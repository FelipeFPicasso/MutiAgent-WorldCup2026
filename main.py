...
{Fore.WHITE}  Powered by LLaMA 3 · RAG · MCP · Agentes Especializados
{Fore.YELLOW}{'='*55}
{Style.RESET_ALL}"""
...
def main():
    ...
    print(f"{Fore.CYAN}[Sistema] Carregando agentes...{Style.RESET_ALL}")
    ...
    while True:
        try:
            ...
            print(f"\n{Fore.YELLOW}Até a próxima! ⚽{Style.RESET_ALL}")
            break
        ...
        if user_input.lower() in ("sair", "exit", "quit"):
            print(f"{Fore.YELLOW}Até a próxima! ⚽{Style.RESET_ALL}")
            break
        ...
        try:
            ...
            print(f"\n{Fore.GREEN}🎙️  Resposta:{Style.RESET_ALL}\n")
            print(resposta)
